window.onload= function() {
  ...
  // --------------Snake 1-------------
  var snack1Array = ["ا1 كوب من زنجبيل إمتنان + 15 حبة لوز خام (مرتين في الاسبوع فقط)","كوب شاي اخضر إمتنان مع الليمون + 1 فاكهة", "حبة فواكه", "ثلاث حبات تمر", "زبيب بحجم قبضة اليد", "فشار"];
  ...
  // --------------Lunch-------------
  var lunchArray = ["نص كوب من العدس الاسود المسلوق + 1 كوب رز بسمتي + 1 كوب شوربة  خضار + سلطة + بي 12", "نص كوب ام عين سوداء + كوب رز بسمتي + شوربة  خضار + سلطة + بي 12", "نص كوب حمص + كوب مكرونة باستا + شوربة خضار + سلطة + بي 12", "ا2 كوب مسقعة مشوية + 1 توست سن + سلطة + بي 12" , "طبق فول مع زيت الزيتون + سلطة + بي 12", "بطاطس متوسطة الحجم + فلفل الوان + جزر + طماطم + اعشاب وبهارات + معلقة زيت زيتون ثم وضعه بالفرن + بي 12", " ا100 جرام برغل نطبخه بالماء ومعلقة زيت زيتون + سلطة + بي 12", "https://bit.ly/38ftfqx", "https://bit.ly/2uD68Yn", "ورق عنب + سلطة + بي 12", "باميا + سلطة + بي12", "نودلز + سلطة + بي 12", "صينية بطاطس + 3 ملاعق رز بني + سلطة + بي 12"];
  var lunchRandom = lunchArray[Math.floor(Math.random()*lunchArray.length)];
  document.getElementById("lunch").textContent = lunchRandom;

  // --------------Snake 2-------------
  var snack2Array = ["كوب شاي إمتنان + 2 خيار", "كوب زنجبيل إمتنان + 2 خيار", "15 حبة لوز (مرتين في الاسبوع فقط)", "حبة فواكه", "ثلاث حبات تمر", "زبيب بحجم قبضة اليد", "فشار"];
  ...
  // --------------Dinner-------------
  var dinnerArray = ["كوب شوربة  عدس + سلطة", "سلطة بالزيت الزيتون", "تبولة مع الاكثار من الخس والبقدونس والطماطم (ممكن اضافة ملعقة برغل)", "حبة فاكهة", "طبق بطيخ متوسط"];
